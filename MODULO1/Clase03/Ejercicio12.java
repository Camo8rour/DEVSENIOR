...
public class Ejercicio12 {
    public static void main(String[] args) {
        /*ENUNCIADO: En un día soleado y caluroso Sebastian y Adriana salen en busca de una sandia. Se dirigen a la tienda más cercana y compran la más grande y jugosa.
